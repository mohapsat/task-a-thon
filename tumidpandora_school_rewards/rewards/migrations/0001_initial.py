# Generated by Django 2.1.1 on 2018-10-22 02:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Status',
            fields=[
                ('status', models.IntegerField(choices=[(1, 'Open'), (2, 'Closed'), (3, 'In Progress'), (4, 'Pending Approval'), (5, 'Approved'), (6, 'Pending Payment'), (7, 'Paid')], default=1, primary_key=True, serialize=False)),
                ('color', models.CharField(default='#007bff', max_length=7)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_on', models.DateTimeField(default=datetime.datetime(2018, 11, 21, 2, 4, 2, 83227))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, default=299.99, max_digits=4)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('charge_id', models.CharField(default=None, max_length=234)),
            ],
        ),
        migrations.CreateModel(
            name='Parent',
        ...
        migrations.AddField(
            model_name='upgradecharge',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='upgradeCharges', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='upgradecharge',
            name='school',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='upgradeCharges', to='rewards.School'),
        ),
        migrations.AddField(
            model_name='task',
            name='starter',
        ...
        migrations.AddField(
            model_name='payment',
            name='task',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='rewards.Task'),
        ),
        migrations.AddField(
            model_name='claim',
            name='approved_by',
        ...
        migrations.AddField(
            model_name='teacher',
            name='school',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='p_school', to='rewards.School'),
        ),
        migrations.AddField(
            model_name='parent',
            name='school',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='t_school', to='rewards.School'),
        ),
    ]
