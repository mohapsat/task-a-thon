"""
Django settings for tumidpandora_school_rewards project.
...
ROOT_URLCONF = 'tumidpandora_school_rewards.urls'
...
WSGI_APPLICATION = 'tumidpandora_school_rewards.wsgi.application'
